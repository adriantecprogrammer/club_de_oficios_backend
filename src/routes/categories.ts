      ...
      content: {
        'application/json': {
          schema: z.object({
            ...
            description: z.string().optional().openapi({ example: 'Servicios de instalación y reparación eléctrica' }),
          }),
        },
      },
    },
      ...
      content: {
        'application/json': {
          schema: z.object({
            ...
            description: z.string().optional().openapi({ example: 'Servicios de plomería en general' }),
          }),
        },
      },
    },
