...
var providerProfiles = sqliteTable("provider_profiles", {
  id: text("id").primaryKey(),
...
var providerCategories = sqliteTable(
  "provider_categories",
  {
...
var reviews = sqliteTable("reviews", {
  id: text("id").primaryKey(),
  requestId: text("request_id").unique().references(() => serviceRequests.id),
  clientId: text("client_id").references(() => users.id),
  providerId: text("provider_id").references(() => providerProfiles.id),
...
var requests_default = requestsRoutes;
...
app.route("/providers", providers_default);
app.route("/request", requests_default);
