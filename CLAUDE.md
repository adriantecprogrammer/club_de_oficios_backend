...
SQLite-based (Turso). Schema defined in `src/db/schema.ts` using Drizzle's `sqliteTable`. Key entities: users, provider_profiles, categories, service_requests, reviews, conversations, messages, payments, achievements.
